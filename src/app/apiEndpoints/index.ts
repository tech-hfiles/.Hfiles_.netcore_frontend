...
export const endpoints = {
   ...
   IMMUNIZATION : {
      ...
      ListDatImmunization :(userId:number) => `${API_NEW_Data}users/${userId}/my-immunizations`,
      EditImmunization : API_NEW_Data + "users/immunizations",
      DeleteImmunization : API_NEW_Data + "users/immunizations"
