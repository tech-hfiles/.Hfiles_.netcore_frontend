        ...
        <div className="privacy-content">
          <div className="policy-section">
            ...
            <p className="policy-paragraph">
              This Privacy Policy pertains and regulates the access and use of the website 
              <strong> http://hfiles.in/</strong> which is operated and owned by 
              <strong> HEALTH FILES MEDICO PRIVATE LIMITED.</strong> This Privacy Policy 
              outlines the procedures and protocols employed by the website http://hfiles.in/ 
              in managing and handling personal and usage information of users (referred to as 
              You or User), in compliance with the relevant laws and regulations of India.
            </p>
          </div>

          <div className="policy-section">
            <h3 className="section-title">Policy Updates and Modifications</h3>
            <p className="policy-paragraph">
              The Privacy Policy is subject to modifications at the discretion of HEALTH FILES 
              MEDICO PRIVATE LIMITED without prior notice. Any alterations to the Privacy Policy 
              will be communicated to all account holders of http://hfiles.in/. The Privacy 
              Policy for http://hfiles.in/ has been designed to be straightforward and informative, 
              detailing the collection of personal and usage information from users. Users who may 
              not be familiar with certain technical terms are encouraged to review the key terms 
              provided.
            </p>
          </div>

          <div className="policy-section">
            <h3 className="section-title">Information Collection for Non-Registered Users</h3>
            <p className="policy-paragraph">
              The website http://hfiles.in/ permits users to navigate its content without requiring 
              registration. Consequently, it does not collect any identifiable personal data such 
              as names, phone numbers, or email addresses that could be used to distinguish 
              individuals when users are simply browsing the website content.
            </p>
          </div>

          <div className="policy-section">
            <h3 className="section-title">Registration Requirements</h3>
            <p className="policy-paragraph">
              If the user desires to register for an account on the website http://hfiles.in/, 
              they are required to furnish their full name, personal mobile number, and email 
              address. This information is necessary to create and maintain user accounts and 
              provide personalized services to registered users.
            </p>
          </div>

          <div className="policy-section">
            <h3 className="section-title">Automatic Data Collection</h3>
            <p className="policy-paragraph">
              The http://hfiles.in/ Portal gathers data including Internet Protocol (IP) Addresses, 
              Domain name, Browser type, Operating System, Date and Time of the visit, Pages visited, 
              Referring URLs, among other information. It is important to note that there is no 
              intention to correlate this data with the identities of individuals visiting the 
              portal, unless there is an unlawful attempt to breach the http://hfiles.in/ service, 
              privacy policy, or violate the provisions of the Information Technology Act, 2000, 
              or any current Rules, Legislation of India.
            </p>
          </div>

          <div className="policy-section">
            <h3 className="section-title">Cookie Usage Policy</h3>
            <p className="policy-paragraph">
              The http://hfiles.in/ System utilizes cookies to store temporary session data aiming 
              to enhance user experience and customize preferences. It is important to note that 
              only temporary cookies are employed, and users have the ability to manage cookie 
              settings through their web browser or other tools. Disabling cookies may disrupt the 
              continuity of the http://hfiles.in/ session. Users are recommended to log out after 
              each session to mitigate potential misuse of cookie data.
            </p>
          </div>

          <div className="policy-section">
            <h3 className="section-title">Data Confidentiality and Protection</h3>
            <p className="policy-paragraph">
              The http://hfiles.in/ System ensures the confidentiality of user information, 
              specifically details obtained during registration, by refraining from sharing or 
              disclosing such data to any party, be it an individual or an organization, unless 
              mandated by legal requirements or explicitly authorized by the account holder. All 
              personally identifiable information submitted on the http://hfiles.in/ Portal/Website 
              is not sold or shared with any third party, whether public or private, except as 
              outlined in specific legal circumstances.
            </p>
          </div>

          <div className="policy-section">
            <h3 className="section-title">Document Sharing and User Control</h3>
            <p className="policy-paragraph">
              Account holders of http://hfiles.in/ retain the autonomy to voluntarily share their 
              uploaded documents or URIs with any party, whether an individual or an organization, 
              by providing explicit consent. It is important to note that the responsibility for 
              sharing documents with requesters or other entities rests solely with the user, as 
              the http://hfiles.in/ system primarily serves as a platform for facilitating document 
              sharing between consenting parties.
            </p>
          </div>

          <div className="policy-section">
            <h3 className="section-title">User Accountability and Compliance</h3>
            <p className="policy-paragraph">
              The individual holding the account on http://hfiles.in/ is accountable for all 
              self-uploaded documents. It is prohibited for the account holder to share or engage 
              in any activities that contravene the terms and conditions, privacy policy, or 
              regulations outlined in the Information Technology Act, 2000, or any other prevailing 
              legislation. Users must ensure all their activities comply with applicable laws and 
              regulations.
            </p>
          </div>

          <div className="policy-section">
            <h3 className="section-title">Legal Disclosure Requirements</h3>
            <p className="policy-paragraph">
              Collected personal and usage data may be disclosed to third-party organizations by 
              HEALTH FILES MEDICO PRIVATE LIMITED if there is a genuine belief that such action is 
              necessary to comply with regulations, legal proceedings, or official government 
              requests; adhere to relevant laws; identify, prevent, or resolve instances of fraud, 
              security breaches, or technical problems; or safeguard the rights, assets, or 
              well-being of http://hfiles.in/, other users, or the general public as mandated or 
              permitted by laws of India.
            </p>
          </div>

          <div className="policy-section">
            <h3 className="section-title">Data Security Measures</h3>
            <p className="policy-paragraph">
              Any data provided to this website will be safeguarded against loss, unauthorized 
              access, disclosure, alteration, or destruction to a reasonable extent. We implement 
              appropriate technical and organizational security measures to protect your personal 
              information in accordance with applicable privacy laws and industry best practices. 
              However, users are also encouraged to take personal precautions to protect their 
              account information and maintain the security of their login credentials.
            </p>
          </div>
        </div>
      </div>
